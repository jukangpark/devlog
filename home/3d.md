...
<figure><img src="../.gitbook/assets/image (1) (1) (1).png" alt=""><figcaption><p>엔지니어 혹은 개발자가 직접 수정해줘야했었던 JS 파일</p></figcaption></figure>
...
첫 프로젝트였지만, 기간안에 프로젝트를 마무리 짓기 위해서는 하이라이트한 부분들은 내가 개발해야만 했다.\
...
<figure><img src="../.gitbook/assets/image (1) (1).png" alt=""><figcaption><p>카메라 버튼으로 2D 뷰 전환</p></figcaption></figure>

<figure><img src="../.gitbook/assets/image (2) (1).png" alt=""><figcaption><p>예약 모드 장비를 예약 할 수 있는 기능</p></figcaption></figure>
