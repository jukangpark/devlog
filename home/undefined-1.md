...
설명의 편의성을 위해 새 프로젝트를 빌더라고 칭하겠다.<br>
...
이렇게 첫 설계에 대한 기획을 마치고 빌더를 개발하기 시작하였다.<br>
...
우선 빌더에서 프로젝트 Project 와 대시보드 Dashboard 라는 큰 개념이 두가지가 있다.<br>
...
<p align="center"><img src="../.gitbook/assets/image (84).png" alt=""><br><br></p>
